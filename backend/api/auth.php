...
class AuthController {
    ...
    public function forgotPassword() {
        ...
        $resetLink = APP_URL . "/frontend/pages/reset-password.html?token=$token";
...
// Finally try URL path
    ...
    // Remove base path
    $urlPath = str_replace('/finsight/backend/api/auth.php', '', $urlPath);
    $urlPath = str_replace('/finsight/backend/api/auth/', '', $urlPath);
